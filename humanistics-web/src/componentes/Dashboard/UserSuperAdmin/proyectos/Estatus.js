...
class EstatusCarousel extends Component{
    ...
    static getDerivedStateFromProps(props, current_state) {
        if (current_state.estatus !== props.estatus && props.estatus !=undefined) {
            return {
    ...
    render(){
        return(
            <div className="carousel-container">
                ...
                >
                    <Button type="link" block className="box-prospectos" onClick={this.estatusControl}>
...

                    {
                        this.state.estatus.map(estatus => {
                            return (
                                <Button type="link" block className="box-prospectos" onClick={()=>this.updateEstatus(estatus._id)}>
