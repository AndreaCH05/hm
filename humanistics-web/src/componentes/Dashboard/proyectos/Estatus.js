...
class Estatus extends Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if(this.state.activos.length === 0 && this.props.data !== undefined){
        	this.setStatus(this.props.data)
        }
    }
    ...
    handleSubmit = () => {
        ...
        this.props.next({estatus: status},2)
    }
        ...
        return (
        	<div>
	                ...
	                <Row className="list-container-row">
	                    ...
	                    <Button type="secondary" className="btn-anterior" onClick={()=>{this.props.prev(2)}}>
							Anterior
						</Button>
	                </Row>
            </div>
